    ...
    <div class="m-t">
        <div id="content-profile" class="content-body">
            <ul class="nav nav-pills">
                <li @if($page == 'dashboard') class="active" @endif role="presentation">{{ HTML::link('user/profile/dashboard', trans('user_texts.dashboard')) }}</li>
                <li @if($page == '') class="active" @endif role="presentation">{{ HTML::link('user/profile', trans('user_texts.profile')) }}</li>
                <li @if($page == 'two-factor-auth') class="active" @endif role="presentation">{{ HTML::link('user/profile/two-factor-auth', trans('user_texts.security')) }}</li>
                <li @if($page == 'balances') class="active" @endif role="presentation">{{ HTML::link('user/profile/balances', trans('user_texts.balance')) }}</li>
                <li @if($page == 'deposit' || $page == 'deposits') class="active" @endif role="presentation">{{ HTML::link('user/profile/deposits', trans('user_texts.deposits')) }}</li>
                <li @if($page == 'withdrawals' || $page=='withdraw') class="active" @endif role="presentation">{{ HTML::link('user/profile/withdrawals', trans('user_texts.withdrawals')) }}</li>
                <li @if($page == 'orders') class="active" @endif role="presentation">{{ HTML::link('user/profile/orders', trans('user_texts.orders')) }}</li>
                <li @if($page == 'trade-history') class="active" @endif role="presentation">{{ HTML::link('user/profile/trade-history', trans('user_texts.trade_history')) }}</li>
                <li @if($page == 'viewtranferout') class="active" @endif role="presentation">{{ HTML::link('user/profile/viewtranferout', trans('user_texts.view_transfer_out')) }}</li>
                <li @if($page == 'viewtranferin') class="active" @endif role="presentation">{{ HTML::link('user/profile/viewtranferin', trans('user_texts.view_transfer_in')) }}</li>
            </ul>
            ...
            <div id='profile-content' class="tab-content">
                ...
                @elseif($page == 'cryptoexchangepoint')
