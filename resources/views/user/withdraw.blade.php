...
<div id="form_deposit">
	<div class="panel panel-default m-t">
	    <div class="panel-heading bg-lightBlue fg-white">{{{ trans('texts.withdraw')}}} - {{$current_coin}}</div>
		    	...
		    	@if(!$wallet->is_moneypaper)
			    	<form id="wihtdrawForm" class="form-horizontal" method="POST" action="{{ url('/user/withdraw') }}">
				    	...
				    	<table class="table table-striped noborder">
				    		...
				    		<tr><td colspan="2">
							  	<div class="text-center"><strong>{{{ trans('user_texts.note_withdraw_1')}}}</strong><br />{{{ trans('user_texts.note_withdraw_2')}}}</div>
							    <div class="col-lg-10">
						  ...
						  <button type="submit" class="btn btn-lg btn-primary">{{trans('texts.withdraw')}}</button>
					</form>
