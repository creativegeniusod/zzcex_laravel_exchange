...
class Admin_SettingController extends Controller {
	...
	*/
			...
			case 'coins-voting':
				...
				if(isset($wallet->id)){
					try{
		                ...
		                $data['error_message']= "Cannot connect to wallet daemon" ;//'Caught exception: '.$e->getMessage()."\n";  //
		            }
    ...
    public function addNewWallet(){
    	...
    	$wallet->save();
			$wallet->wallet_password = Crypt::decrypt($wallet->wallet_password);
    	if ( $wallet->id ){
	...
	public function doEditWallet(){
        ...
        $wallet->wallet_password = Crypt::encrypt('password');
